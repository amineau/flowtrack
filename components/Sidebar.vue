        ...
        <li>
          <NuxtLink to="/activities">
            ...
            >
              ...
              <span
                class="inline-flex items-center justify-center w-3 h-3 py-3 px-4 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-lg dark:bg-blue-900 dark:text-blue-300"
                >736</span
              >
            </div>
          </NuxtLink>
        ...
        <li>
          <NuxtLink to="/heatmap">
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Heatmap</span>
            </div>
          </NuxtLink>
        </li>
        <li>
